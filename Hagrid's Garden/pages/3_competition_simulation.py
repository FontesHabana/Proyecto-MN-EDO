...
st.set_page_config(page_title="Two Species Competition Simulation",layout='wide',initial_sidebar_state="collapsed")
...
with sidebar_col:
    ...
    st.markdown(
        "**Adjust the parameters below to see how two magical populations compete for limited resources!**"
    )
